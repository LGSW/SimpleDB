...
public class Transaction {
	...
	private ConcurrencyMgr concurMgr; // ConcurrencyMgr_New
	private int txnum;
	...
	public Transaction() {
		...
		concurMgr = new ConcurrencyMgr();// ConcurrencyMgr_New
		count++;
		...
		// if a checkpoint is performing add it to wait list otherwise to
		// active.
		if (isChecking == false) {
